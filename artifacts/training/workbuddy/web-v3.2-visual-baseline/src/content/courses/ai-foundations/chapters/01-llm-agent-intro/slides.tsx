...
const slides: DeckSlide[] = [
  {
    ...
    content: <SlideFrame eyebrow="30 MIN · 全员认知培训" title="大模型与智能体：从理解到行动" lead="沿一项可以验收的办公任务，看懂智能软件内部如何协作。" dark className="justify-center"><CoverVisual /></SlideFrame>,
  },
  {
    id: "case",
  ...
  },
  {
    ...
    content: <SlideFrame eyebrow="04 · 概念定位" title="五个概念分别出现在哪里？" lead="点击左侧标签切换；它们是智能软件中的不同层次，不是五种同类产品。"><ConceptExplorer /></SlideFrame>,
  },
  {
  ...
  },
  {
    ...
    content: <SlideFrame eyebrow="12 · 智能体状态" title="智能体一边推进，一边维护当前任务状态" dark><AgentStateBoard /><SlideTakeaway dark>状态让每一步有依据，也让失败后能够继续、检查和接管。</SlideTakeaway></SlideFrame>,
  },
  {
    id: "agent-loop",
  ...
  },
  {
    ...
    content: <SlideFrame eyebrow="16 · 软件如何工作" title="把概念连成一条有证据的任务链" lead="每个节点都留下不同证据，最终结果才能回溯。" dark><EvidenceTimeline /><SlideTakeaway dark>每一步都应该能看到输入、动作、返回结果、当前状态和验收依据。</SlideTakeaway></SlideFrame>,
  },
  {
    id: "failures",
    title: "任何一环都可能停下来",
  ...
  },
  {
    ...
    content: <SlideFrame eyebrow="20 · 快速判断" title="三个说法，检验是否真正理解边界" dark><QuizPanels /></SlideFrame>,
  },
  {
    id: "summary",
    title: "理解智能体，从理解边界开始",
    ...
    content: <SlideFrame eyebrow="本次带走" title="理解智能体，从理解边界开始" lead="五句话对应五个核心概念，最后重新连成一条责任链。" dark><SummaryChain /><SlideTakeaway dark>把工作交给 AI 软件，不等于把责任交出去。</SlideTakeaway></SlideFrame>,
  },
];
